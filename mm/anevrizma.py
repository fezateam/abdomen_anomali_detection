...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/akay/Masaüstü/mm/mmdetection/datasets/saglik/aort/train/aorttrain.json',
        img_prefix=
        '/home/akay/Masaüstü/mm/mmdetection/datasets/saglik/aort/train/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=(640, 640), keep_ratio=True),
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/akay/Masaüstü/mm/mmdetection/datasets/saglik/aort/val/aortval.json',
        img_prefix=
        '/home/akay/Masaüstü/mm/mmdetection/datasets/saglik/aort/val/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=100))
classes = ('aort', )
work_dir = './work_dirs/aort_cnext_pafpn_thead'
auto_resume = False
gpu_ids = [0]
